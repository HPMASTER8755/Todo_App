...
function Todos({ todo:t }) {
    ...
    const deleteTodo = async () => {
        const response = await fetch("https://todo-app-pf7q.onrender.com/api/todos/"+ t._id, {
            method: "DELETE",
            headers: {
            ...
            : <div className='todo-container'>
                <div className='todos'>
                    ...
                    <div>
                        ...
                        <MdOutlineDownloadDone onClick={handleCompleted} size={25} cursor="pointer" title='Done' />
                    </div>
                </div>
